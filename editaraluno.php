...
<p class="text"> CPF: <br> <input class="barra" type="text" name="cpf" value="<?php echo $_POST ['cpf'];?>" required/></p>
<p class="text"> Email: <br> <input class="barra" type="text" name="email" value="<?php echo $_POST ['email'];?>" required/></p>
<p class="text"> Endereço: <br> <input class="barra" type="text" name="endereço" value="<?php echo $_POST ['endereço'];?>" required/></p>
