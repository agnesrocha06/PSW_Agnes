...
<?php
    ...
    <input type="submit" value="EDITAR" style="margin-left: 10px; width:70px; background-color: rgb(110, 110, 255); margin-bottom: 10px;">
    </form>

    <form action="home.php" method="post">
    <button type="submit" value="home" style="margin-left: 10px; height: 45px; width:70px; background-color: rgb(110, 110, 255);">
        <p>Home</p>
        </button>
    </form>
