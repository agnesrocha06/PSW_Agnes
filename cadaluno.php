...
<?php
    ...
    <div class="menu" style="height:550px; background-color: Lavender; margin:0; justify-content: center; text-align: center;">
       ...
       <p class="text"> CPF: <br> <input class="barra" type="text" name="cpf" placeholder="XXX.XXX.XXX-XX" required ></p>
